...
if __name__ == '__main__':
    ...
    parser.add_argument('--context_dim', type=int, help='Set dimension of context features.')
    parser.add_argument('--hidden_dim', type=int, help='Set dimension of hidden features.')
